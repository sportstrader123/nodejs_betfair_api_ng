...
module.exports = {
	...
	createListMarketCatFilter: function (evid_arr, country_arr, market_type_arr, start_time, end_time, max_results) {
		
		// Create a market filter using the supplied arrays of evend type IDs, contries, market types
